...
create or replace function shared_system.put_to_str (in_list varchar[], delimiter varchar, prefix varchar) returns varchar as $BODY$
begin
...
create or replace function shared_system.put_to_str (in_list varchar[], prefix varchar) returns varchar as $BODY$
begin
    return shared_system.put_to_str (in_list, ',', prefix);
end;
$BODY$
language plpgsql
immutable;
...
create or replace function shared_system.put_to_str (in_list varchar[]) returns varchar as $BODY$
begin
    return shared_system.put_to_str (in_list, ',', '');
end;
$BODY$
language plpgsql
immutable;